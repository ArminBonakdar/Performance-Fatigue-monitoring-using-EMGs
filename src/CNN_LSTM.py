...
# -------------------------
file_path = 'drive/MyDrive/NCB-Armin/Fatigue analysis/MSc_Project/EMG_MainProject/Results/MLFeatures.xlsx'
...
for subj in unique_subjects:
    subj_indices = (subject == subj)
    scaler = StandardScaler()
    normalized_features[subj_indices] = scaler.fit_transform(features[subj_indices])
...
for subj in unique_subjects:
    idx = subject == subj
    subj_features = normalized_features[idx]
